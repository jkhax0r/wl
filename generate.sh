...
# Docker
./dns_probe.sh docker.txt 1000 "index.docker.io" "registry-1.docker.io" "docker.io" "production.cloudfront.docker.com" "docker.com" "download.docker.com" "ppa.launchpadcontent.net" "download.docker.com"

# Ubuntu Updates
./dns_probe.sh ubuntuupdate.txt 1000 "archive.ubuntu.com" "security.ubuntu.com" "us.archive.ubuntu.com" "api.snapcraft.io" "dashboard.snapcraft.io" "login.ubuntu.com" "contracts.canonical.com" "esm.ubuntu.com" "repo.mongodb.org"
